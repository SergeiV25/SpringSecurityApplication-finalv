...
//                .antMatchers("/user").hasAnyRole("USER")
                ...
                .antMatchers( "/auth/login", "/error", "/auth/registration", "/product", "/product/info/{id}", "/img/**", "/product/search", "/search", "/product/product").permitAll()
...
//                .anyRequest().authenticated()
    ...
    public void configure(WebSecurity web) throws Exception {
        web
                .ignoring()
                .antMatchers("/resources/**", "/static/**", "/pics/**", "/style/**", "/style/admin/**", "/style/product/**", "/style/user/**");
    }
